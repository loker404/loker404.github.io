const rulesLabel = "Using Tromp-Taylor rules, komi -1.5";
const rulesLink = "https://tromp.github.io/go.html";
const devMode = false;
const bSizeX = 19;
const bSizeY = 19;
...
{
  const pixelsPerTile = 20.0 * Math.sqrt(Math.sqrt((bSizeX-1)*(bSizeY-1)) / 8);
